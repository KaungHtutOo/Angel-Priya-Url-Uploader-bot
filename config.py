...
class Config(object):
    ...
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6196611857:AAE-ye0j_OIYhtFWhBTOh7KP53vOew_3nno")
    ...
    DEF_THUMB_NAIL_VID_S = os.environ.get("DEF_THUMB_NAIL_VID_S", "https://root.onechannel22.workers.dev/0:/test.mkv")
